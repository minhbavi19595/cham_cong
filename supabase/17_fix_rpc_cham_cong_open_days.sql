-- =============================================================
-- 17_FIX_RPC_CHAM_CONG_OPEN_DAYS.SQL
-- Xoá bỏ hoàn toàn bảng attendance_open_days khỏi rpc_cham_cong
-- Khôi phục lại logic "Khoá tháng cũ" (từ file 06) kết hợp với 
-- sửa lỗi ghi log giải trình (RETURNING id) của file 15.
-- =============================================================
...
BEGIN
  ...
  -- 3. Kiểm tra ngày hợp lệ (KHOÁ THÁNG)
  -- Không cho phép chấm các ngày thuộc tháng cũ
  ...
  IF v_existing_id IS NULL THEN
    ...
    RETURNING id INTO v_existing_id; -- QUAN TRỌNG: Lấy ID để ghi log
  ELSE
